...
<script lang="ts">
  ...
  const base =
    "inline-flex h-[14px] items-center justify-center gap-1 rounded-sm border px-1.5 text-[9px] uppercase leading-none tracking-[0.32em] transition disabled:cursor-not-allowed disabled:opacity-40";
