...
use crate::user_services::UserServices;
...
mod tests {
    use super::*;
    use crate::jwt::codec::encode_hs256;
    use crate::store::MemoryUserStore;
    use crate::types::{DEFAULT_PASSWORD_VERSION, User};
    ...
    fn build_token(
        ...
        encode_hs256(&claims, jwt.jwt.secret.as_ref()).expect("encode token")
    }
