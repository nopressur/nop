...
fn embedded_template_loader(name: &str) -> Result<Option<String>, minijinja::Error> {
    let template_content = match name {
        // Error pages
        "error_404.html" => Some(include_str!(
            "../../nop-public/src/templates/error_404.html"
        )),
        "error_500.html" => Some(include_str!(
            "../../nop-public/src/templates/error_500.html"
        )),

        // Login templates
        "login/login_page.html" => {
            Some(include_str!("../../nop-rt-login/templates/login_page.html"))
        }
        "login/profile_page.html" => Some(include_str!(
            "../../nop-rt-login/templates/profile_page.html"
        )),
        "login/oidc_auth.html" => Some(include_str!("../../nop-rt-login/templates/oidc_auth.html")),

        // Admin SPA shell
        "admin/spa_shell.html" => {
            Some(include_str!("../../nop-admin/src/templates/spa_shell.html"))
        }
        ...
        "public/shortcode/video.html" => Some(include_str!(
            "../../nop-public/src/shortcode/templates/video.html"
        )),
        "public/shortcode/link_card.html" => Some(include_str!(
            "../../nop-public/src/shortcode/templates/link_card.html"
        )),
