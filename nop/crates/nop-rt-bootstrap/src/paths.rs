...
pub const RED_THEME_THEME: &str =
    include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/themes/red.theme"));
...
mod tests {
    use super::*;
    use nop_config::ValidatedConfig;
    use nop_config::test_local_users_config;
    use nop_config::{
    ...
    use nop_config::{TlsConfig, TlsMode};
    use nop_content_store::flat_storage::read_sidecar;
    use std::fs;
    ...
    fn creates_default_index_when_no_content() {
        let fixture = new_fixture("bootstrap-content");
