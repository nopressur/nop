...
use nop_management_contract::registry::{DomainActionKey, DomainDescriptor};
use nop_management_contract::{ManagementRequest, ManagementResponse};
...
mod tests {
    use super::*;
    use nop_management_contract::registry::ActionDescriptor;
