...
mod tests {
    ...
    fn load_rejects_servers_section() {
        let fixture = temp_root("config-servers");
...
"#,
    ...
    fn load_and_validate_clamps_search_worker_count_to_max_with_warning_path() {
        let fixture = temp_root("config-search-clamp");
    ...
    fn load_and_validate_rejects_zero_search_worker_count() {
        let fixture = temp_root("config-search-worker-zero");
    ...
    fn load_and_validate_rejects_zero_search_max_memory_mb() {
        let fixture = temp_root("config-search-memory-zero");
